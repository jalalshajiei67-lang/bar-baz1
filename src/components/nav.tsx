...
export function Nav() {
  ...
  return (
    <header className="sticky top-0 z-[500] border-b border-black/10 bg-white/85 backdrop-blur print:hidden dark:border-white/10 dark:bg-black/70">
      <nav className="mx-auto flex w-full max-w-5xl items-center gap-1 overflow-x-auto px-4 py-2.5">
        <span className="me-2 shrink-0 text-sm font-semibold tracking-tight">
          بار-باز
        </span>
        {links.map((link) => {
          const active =
