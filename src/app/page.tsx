...
const sections = [
  ...
  },
  {
    ...
    title: "مالی",
    description:
      "بدهی هر مشتری، ثبت پرداختی‌ها و جمع کل فاکتورهای پرداخت‌نشده",
  },
  {
    href: "/fleets",
    title: "ناوگان",
    description: "ماشین‌هایی که بار را می‌برند و صفحه‌ی راننده‌ی هرکدام",
  },
];
  ...
  return (
    <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-10 sm:px-6 sm:py-14">
      ...
      <p className="mt-8 text-xs opacity-50 sm:mt-10">
        روال روزانه: ادمین فاکتور مشتری را می‌سازد ← میوه‌ها و تعداد جعبه‌ها را
        می‌زند و ناوگان حامل بار را انتخاب می‌کند ← راننده سر بار وزن و قیمت و
